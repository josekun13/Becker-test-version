...
int main(int argc, char **argv)
{
	...
	kf[3]=-0.0;
	ros::NodeHandle n;
	ros::Subscriber sub = n.subscribe("imumsg",10,imudata);   //se declaran los datos de entrada y se inicializan los hilos
	...
	ros::Rate loop_rate(80); //la cantidad de veces que se repite por segundo
	while(ros::ok()){
		std::stringstream sb;
		control();   // el control
